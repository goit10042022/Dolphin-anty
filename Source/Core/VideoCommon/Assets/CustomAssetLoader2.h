...
public:
  ...
  std::vector<std::size_t> LoadAssets(std::list<CustomAsset*> pending_assets, u64* memory,
                                      u64 max_memory_allowed);
...
private:
  ...
  u64 m_completed_asset_memory = 0;
